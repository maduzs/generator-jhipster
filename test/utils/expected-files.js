...
const expectedFiles = {
    ...
    client: [
        ...
        `${CLIENT_MAIN_SRC_DIR}content/images/whitestein.png`,
        `${CLIENT_MAIN_SRC_DIR}content/images/whitestein2x.png`,
        `${CLIENT_MAIN_SRC_DIR}content/images/logo-whitestein.png`,
